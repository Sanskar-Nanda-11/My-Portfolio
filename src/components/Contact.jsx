        ...
        <section className='p-8 w-full md:w-1/2'>
          ...
          <form className='space-y-4'>
            <div>
              ...
              <input type="text" name='name' id='name' placeholder='Your Name' className='w-full px-4 py-2 text-white bg-gray-900 rounded-lg focus:outline-none' onChange={handleChange}/>
            </div>
            <div>
              <label htmlFor="email" className='block text-gray-300 font-medium mb-2'>Email</label>
              <input type="email" name='email' id='email' placeholder='Your Email' className='w-full px-4 py-2 text-white bg-gray-900 rounded-lg focus:outline-none' onChange={handleChange}/>
            </div>
            <div>
            <label htmlFor="subject" className='block text-gray-300 font-medium mb-2'>Subject</label>
              <input type="text" name='subject' id='subject' placeholder='Your Subject' className='w-full px-4 py-2 text-white bg-gray-900 rounded-lg focus:outline-none' onChange={handleChange}/>
            </div>
            <div>
              ...
              <textarea name="message" id="message" placeholder='Your Message' className='w-full px-4 py-2 text-white bg-gray-900 rounded-lg focus:outline-none' onChange={handleChange} ></textarea>
            </div>
