...
const Contact = () => {
    return (
        <section data-aos='fade-up' data-aos-delay='300' className=' min-h-screen overflow-hidden flex items-center p-6 m-10 relative '> 
        <article className='shadow-lg rounded-lg flex flex-col md:flex-row max-w-4xl w-full relative'> 
            ...
            <form className='spec-y-4'>
                ...
                <div>
                    <label htmlFor="Messages" className=' block text-gray-300 font-medium mb-2 '> Messages </label>
